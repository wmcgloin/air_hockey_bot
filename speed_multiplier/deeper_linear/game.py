...
class AirHockeyGame:
    def __init__(self, screen, mode = 'rlve', speed_multiplier=1.0):
        ...
        # Create game objects
        self.puck = Puck(400, 200, 15, self.screen_width, self.screen_height, speed_multiplier)
        self.player1_paddle = Paddle(200, 200, 30, self.screen_width, self.screen_height, 0, mid_point - 10, speed_multiplier)
        self.player2_paddle = Paddle(600, 200, 30, self.screen_width, self.screen_height, mid_point + 10, self.screen_width, speed_multiplier)
    ...
    def calculate_rewards(self):
        ...
        #     reward -= 5 # Penalty for letting the puck into the goal
        # # winning/losing
        if self.game_over:
