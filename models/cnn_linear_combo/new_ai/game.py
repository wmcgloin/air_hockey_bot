...
class AirHockeyGame:
    ...
    def update_pve(self):
        if self.basic_ai_paddle:
            ...
            if self.puck.y > self.basic_ai_paddle.y + self.basic_ai_difficulty * 175: # creates slight reaction delay
                self.basic_ai_paddle.dy = self.basic_ai_paddle.speed
            elif self.puck.y < self.basic_ai_paddle.y - self.basic_ai_difficulty * 175: # creates slight reaction delay
                self.basic_ai_paddle.dy = -self.basic_ai_paddle.speed
            else:
